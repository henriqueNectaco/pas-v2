    ...
    <>
      <div className={`bg-blue-600 flex flex-row lg:grid lg:grid-cols-5 shadow-[0_0_7px_3px]  `}>
        <div className=' text-white  flex items-center p-6 lg:col-span-1 w-full'>
          <TextAlignJustify size={40} onClick={props.showSiderbar} className='hover:cursor-pointer' /></div>
        <div className='hidden col-span-3  lg:flex flex-row p-6 items-center gap-6 justify-center'>
          <Link href={`${process.env.NEXT_PUBLIC_BASE_URL}/dashboard`} onClick={props.closeSideBar} className='text-lg text-white'>Dashboard</Link>
          <Link href={`${process.env.NEXT_PUBLIC_BASE_URL}/vendas`} onClick={props.closeSideBar} className='text-lg text-white'>Vendas</Link>
          <Link href={`${process.env.NEXT_PUBLIC_BASE_URL}/marketplaces`} onClick={props.closeSideBar} className='text-lg text-white'>Marketplaces</Link>
          <Link href={`${process.env.NEXT_PUBLIC_BASE_URL}/crons`} className='text-lg text-white' onClick={props.closeSideBar}>Crons</Link>
        </div>
