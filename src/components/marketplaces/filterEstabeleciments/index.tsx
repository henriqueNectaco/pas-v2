...
import { propsFilterEstabeleciment } from '@/types/marketplaces/marketplaces'
export default function FilterEstabeleciments(
  props: propsFilterEstabeleciment,
) {
  return (
    <div className="flex flex-col lg:grid lg:grid-cols-5 w-full rounded-xl mb-2 bg-white">
